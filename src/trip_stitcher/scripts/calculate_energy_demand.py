...
def calculate_energy_demand(
    ...
    energy_demand = ed_estimator.calculate_energy_demand(
        trip, bus_type=bus_type, aux_power=aux_power
    )
...
def main():
    ...
    run_pipeline(
        partial(calculate_energy_demand, ed_estimator=ed_estimator, bus_type=args.bus_type, df=df),
        Trip,
        args,
    )
